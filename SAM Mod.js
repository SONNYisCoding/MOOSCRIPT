// ==UserScript==
// @name        SamMod V-0.6 | 2020 |
// @namespace    -
// @version     0.6
// @description yes
// @author       Sam(DisGusted Duke) + solo_wolf
// @match        *://moomoo.io/*
...
! function(e) {
    ...
    (function(t) {
        e.exports.maxScreenWidth = 1920, e.exports.maxScreenHeight = 1080, e.exports
            ...
            .nameY = 34, e.exports.skinColors = ["#bf8f54", "#cbb091", "#896c4b", "#fadadc", "#ececec", "#c37373", "#4c4c4c", "#ecaff7", "#738cc3", "#9100ff"
                ...
                "SUB TO SAM","SUB TO SAM","SUB TO SAM","SUB TO SAM","SUB TO SAM","SUB TO SAM","SUB TO SAM","SUB TO SAM","SUB TO SAM","SUB TO SAM","SUB TO SAM","SUB TO SAM","SUB TO SAM","SUB TO SAM","SUB TO SAM","SUB TO SAM","SUB TO SAM","SUB TO SAM","SUB TO SAM"
	...
	var at = document.getElementById("featuredYoutube"),
		ot = [{
			name: "Disgusted Duke",
			link: "https://www.youtube.com/channel/UCtTSlXRD10KPtiAjRLpuQuA?sub_confirmation=1"
		}, {
		}],
						...
						if ((_ = W[a] || Y[a - W.length]).visible && (10 != _.skinIndex || _ ==
							...
							if ("" != w) {
								if (be.font = (_.nameScale || 30) + "px Hammersmith One", be.fillStyle =
									"silver", be.textBaseline = "middle", be.textAlign = "center", be.lineWidth =
...
let instaChat = "gg"  //
let quadChat = "gg" // change if you want to
$("#consentBlock").css({display: "none"});
//$("#youtuberOf").css({display: "none"});
if(changelook == true){
$("#mapDisplay").css({background: `url('')`});
}
$('#ageBarContainer')['append']('<div style=\"width: 100%;position: absolute;top: 100px;text-align: center;color: red;font-size: 12px;\">\x0aR - Instakill | H - 2 Turrets | V - Spike | T Toggle Auto heal | G - Spike + Boost | N - Mill | Ctrl - 4 windmill | Q(hold) - Anti Insta| Esc - Menu | \x0a</div>')
...
document.getElementById("leaderboard").append('|V-0.6|');
document.getElementById('loadingText').innerHTML = "|V-0.6 Loading|";
...
document.addEventListener('keydown', (e)=>{
    ...
    if (e.keyCode == 76 && document.activeElement.id.toLowerCase() !== 'chatbox') {
        ...
        setTimeout( () => {
            document.getElementById("woodDisplay").innerHTML = "MAX";
            document.getElementById("stoneDisplay").innerHTML = "MAX";
            doNewSend(["9", [null]]);
        }, 75);
    }
   ...
   if (e.keyCode == 74 && document.activeElement.id.toLowerCase() !== 'chatbox') {
    ...
    if(e.keyCode == 82 && document.activeElement.id.toLowerCase() !== 'chatbox') {
        autoaim = true;
        doNewSend(['ch', ['SamMod V-0.6 By sam#7707']]);
        ...
        if (e.keyCode == 186 && document.activeElement.id.toLowerCase() !== 'chatbox') {
            if (instaSpeed == 230) {
                instaSpeed = 200;
                doNewSend(["ch", [" Insta:200"]]);
            }else {
                doNewSend(["ch", [" Insta:230"]]);
                instaSpeed = 230;
            }
    }
    if (e.keyCode == 222 && document.activeElement.id.toLowerCase() !== 'chatbox') {
            if (healSpeed == 130) {
                healSpeed = 110;
                doNewSend(["ch", ["Heal:110"]]);
            }else {
                doNewSend(["ch", [" Heal:130"]]);
                healSpeed = 130;
            }
    }
...
document.getElementById("gameName").innerHTML = "| Sam | MoD | V-0.6 |"
setInterval(() => {
    setTimeout( () => {
        document.getElementById("gameName").innerHTML = "| -am | MoD | V-0.6";
        setTimeout( () => {
            document.getElementById("gameName").innerHTML = "| S-m | MoD | V-0.6 |";
            setTimeout( () => {
                document.getElementById("gameName").innerHTML = "| Sa- | MoD | V-0.6 |";
                setTimeout( () => {
                    document.getElementById("gameName").innerHTML = "| Sam | -oD | V-0.6 |";
                    setTimeout( () => {
                        document.getElementById("gameName").innerHTML = "| Sam | M-D | V-0.6 |";
                        setTimeout( () => {
                            document.getElementById("gameName").innerHTML = "| Sam | Mo- | V-0.6 |";
                            setTimeout( () => {
                            document.getElementById("gameName").innerHTML = "| Sam | MoD | --0.6 |";
                                setTimeout( () => {
                            document.getElementById("gameName").innerHTML = "| Sam | MoD | V-0.6 |";
                                   }, 50);
                                }, 50);
...
settings.src = "data:image/png;base64,"
settings.style = `position: absolute; bottom: 20px; left: 175px; z-index: 100000; width: 100px; height: 100px; cursor: pointer; border-radius: 50%;`;
...
(function() {
    ...
    var ezsound = new Audio("https://www.myinstants.com/media/sounds/movie_1.mp3");
    ...
    function getkills(){
        ...
        if(count > kills){
            ezsound.play();
            doNewSend(["ch", ["SamMod Kills:"+count]]);
        }
        kills = count;
    }
})();
