// ==UserScript==
// @name         PENIS mod | Katana + Musket | AUTOHEAL |  Anti-Insta  |  starter resources and more!!
// @version      v.1.0
// @description  Enjoy the mod GAY!
// @author       SONNY
// @match        *://moomoo.io/*
// @match        *://dev.moomoo.io/*
// @match        *://*.moomoo.io/*
...
document.getElementById('linksContainer2').innerHTML = ' Suck my penis! ' ;
document.getElementById('gameName').innerHTML = '🤣Penis Mod🤣';
...
document.getElementById('diedText').innerHTML = "!!YOU GOT KILLED!!";
...
document.title = ' penis mod🤣';
document.getElementById("leaderboard").append ('Penis mod');
            ...
            typeof pingTime !== "undefined" &&
                ...
                if (oldPing >= 101 && oldPing <= 250) {
                    ...
                    if(document.getElementById("pingy").checked){
                        newSend(["ch", ["lol ~" + oldPing + " ms~"]])
                    }
                }
                if (oldPing >= 251) {
                    pingSpan.style.color = "red";
                    if(document.getElementById("pingy").checked){
                        newSend(["ch", ["LAG ~" + oldPing + " ms~"]])
                    }
                }
            })());
        });
...
function handleMessage(_x17) {
    ...
    if (token == 'h' && node[1] == myPlayer.id) {
        if (node[2] <= 46 && node[2] > 0 && antiinsta == true) {
            ...
            newSend(["ch",["SO Sad Try AgaiN GAY!!!"]])
        }
...
document['addEventListener']('keydown', function(a) {
    ...
    if (a.keyCode == 76 && document.activeElement.id.toLowerCase() !== 'chatbox') {
        if(primary == 0){
            ...
            autoaim = true;
            newSend(["ch", ['My~BOW~INSTA~Not~WoRkin']]);
            newSend(["5", [secondary, true]]);
            newSend(["13c", [0, 21, 1]]);
            newSend(["13c", [1, 53, 0]]);
            newSend(["13c", [0, 53, 0]]);
        ...
        <div id="simpleModal" class="modal">
            <div class="modal-content">
                ...
                <div class="modal-body" style="font-size: 15px;">
                    ...
                    <h2 style="font-size: 20px;">MeNu</h2>
